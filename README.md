...
[image6]: ./examples/compare.png "Compare"
...
The those image might be difficult to classify because some of image is blur and some thing cover on signs. Besides, I found that my classifier cannot recognize some of signs clearly because they are similar. Maybe I need to add dropout? So that each features can be independent.
...
Answer both of two question together as below.
...
The model was able to correctly guess 12 of the 18 traffic signs, which gives an accuracy of 66%%. This compares favorably to the accuracy on the test set that worse.
